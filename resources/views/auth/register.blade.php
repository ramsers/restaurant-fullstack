    ...
    <form class="splash-container" method="POST" action="{{ route('register') }}">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group">
                            <input id="email" placeholder="Email" type="email" class="form-control form-control-lgl @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">

                        ...
                        <div class="card-body">
                            <form action="#" id="basicform" data-parsley-validate="" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputCategoryImageUrl" type="text" name="imageUrl" data-parsley-trigger="change" required="" placeholder="http://www.billys.com/img/burgers.jpg" autocomplete="off" class="form-control">
                                </div>
                                <div class="row">

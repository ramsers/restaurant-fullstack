                ...
                <div class="page-header">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-items"><a href="/admin" class="breadcrumb-link">Dashboard</a></li>
                                <li class="breadcrumb-items"><a href="/admin/food-items" class="breadcrumb-link">All Food Items</a></li>
                                <li class="breadcrumb-items active" aria-current="page">Edit Food Items</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <form action="#" id="basicform" data-parsley-validate="" novalidate="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputItemImageUrl" type="text" name="imageUrl" data-parsley-trigger="change" required="" placeholder="http://www.billys.com/img/burgers.jpg" autocomplete="off" class="form-control">
                                </div>
                                <div class="row">
